                        ...
                        if (e instanceof t.Sprite) {
                            ...
                            s &&
                                ...
                                this.smoothProperty &&
                                    ...
                                    ((this.scaleMode = e.texture.baseTexture.scaleMode), (r[this.smoothProperty] = this.scaleMode === t.BaseTexture.SCALE_MODE.LINEAR)),
    ...
    return (
        ...
        (n.PluginManager.prototype = {
            add: function (e) {
                ...
                return (
                    ...
                    t
                        ? ((e.hasPreUpdate || e.hasUpdate || e.hasPostUpdate) && (e.active = !0),
        ...
        Object.defineProperty(n.Stage.prototype, "backgroundColor", {
            ...
            set: function (e) {
                (this._backgroundColor = e),
                    this.game.transparent === !1 && (this.game.renderType == n.CANVAS ? (this.game.canvas.style.backgroundColor = e) : ("string" == typeof e && (e = n.Color.hexToRGB(e)), this._stage.setBackgroundColor(e)));
            },
        }),
        ...
        (n.Keyboard.prototype = {
            ...
            processKeyUp: function (e) {
                this.game.input.disabled ||
                    ...
                    this._keys[e.keyCode]
                        ? ((this._keys[e.keyCode].isDown = !1), (this._keys[e.keyCode].timeUp = this.game.time.now))
                        : (this._keys[e.keyCode] = { isDown: !1, timeDown: this.game.time.now, timeUp: this.game.time.now, duration: 0 }));
            },
            reset: function () {
        ...
        (n.Mouse.prototype = {
            ...
            pointerLockChange: function (e) {
                ...
                document.pointerLockElement === t || document.mozPointerLockElement === t || document.webkitPointerLockElement === t
            ...
            processAxisChange: function (e) {
                this.game.input.disabled ||
                    ...
                    (this._axes[e.axis] !== e.value &&
                        ((this._axes[e.axis] = e.value),
                        this._padParent.onAxisCallback && this._padParent.onAxisCallback.call(this._padParent.callbackContext, e, this._index),
                        this.onAxisCallback && this.onAxisCallback.call(this.callbackContext, e)));
            },
        ...
        (n.Button.prototype.onInputUpHandler = function (e, t, n) {
            this.onUpSound && this.onUpSound.play(this.onUpSoundMarker),
                ...
                this.freezeFrames || this.setState(this.forceOut ? 2 : this._onUpFrameName || this._onUpFrameID ? 4 : n ? 1 : 2);
        }),
        ...
        (n.Math = {
            ...
            interpolateAngles: function (e, t, n, r, i) {
                return (
                    ...
                    "function" == typeof i ? i(n, e, t - e, 1) : this.interpolateFloat(e, t, n)
                );
            },
            ...
            XMLData: function (e, r, i) {
                ...
                for (var s, o, u, a, f, l, c, h, p, d, v, m, g = new n.FrameData(), y = r.getElementsByTagName("SubTexture"), b = 0; b < y.length; b++)
                    (o = e.rnd.uuid()),
                        ...
                        (null !== p || null !== d) &&
                            (s.setTrim(!0, c, h, p, d, v, m), (t.TextureCache[o].realSize = { x: p, y: d, w: v, h: m }), (t.TextureCache[o].trimmed = !0), (t.TextureCache[o].trim.x = p), (t.TextureCache[o].trim.y = d));
                return g;
            },
        }),
        (n.Cache = function (e) {
        ...
        (n.Loader.prototype = {
            ...
            spritesheet: function (e, t, n, r, i, s, o) {
                return (
                    ...
                    this.addToFileList("spritesheet", e, t, { frameWidth: n, frameHeight: r, frameMax: i, margin: s, spacing: o }),
                    this
                );
            },
        ...
        (function (e, t) {
            ...
            (h.Vector = e),
                ...
                (e.prototype.rotatePrecalc = e.prototype.rotatePrecalc = function (e, t) {
                    var n = this.x,
                        r = this.y;
                ...
                (h.Circle = t),
                (h.Polygon = n),
                (n.prototype.recalc = n.prototype.recalc = function () {
                ...
                (n.prototype.scale = n.prototype.scale = function (e, t) {
                    var n,
                        r = this.points,
                        i = this.edges,
                        s = this.normals,
                ...
                (h.Box = r),
                (r.prototype.toPolygon = r.prototype.toPolygon = function () {
                    var t = this.pos,
                        r = this.w,
                        i = this.h;
        ...
        (n.Physics.Arcade.prototype = {
                    ...
                    for (var s = e._container.children.length, o = 0; s > o; o++)
                        for (var u = o + 1; s >= u; u++)
                            e._container.children[o] &&
                                ...
                                this.collideSpriteVsSprite(e._container.children[o], e._container.children[u], t, n, r, i);
            },
            ...
            separate: function (e, t, n, r, i) {
                return e === t || this.intersects(e, t) === !1
                    ...
                    ? !1
                    : (this._response.clear(), i ? e.overlap(t, this._response) : e.overlap(t, this._response) ? e.separate(t, this._response) : !1);
            },
            intersects: function (e, t) {
                var n = !1;
            ...
            putTile: function (e, t, r, i) {
                (i = this.getLayer(i)),
                    t >= 0 &&
                        ...
                        (e instanceof n.Tile ? this.layers[i].data[r][t].copy(e) : (this.layers[i].data[r][t].index = e), (this.layers[i].dirty = !0), this.calculateFaces(i));
            },
            ...
            parseTiledJSON: function (e) {
                ...
                for (var i = 0; i < t.tilesets.length; i++)
                    for (
                        ...
                        ((t.tiles[f] = [o, b, i]), (o += g.tileWidth + g.tileSpacing), w++, w !== g.total) &&
                        (E++, E !== g.columns || ((o = g.tileMargin), (b += g.tileHeight + g.tileSpacing), (E = 0), S++, S !== g.rows));
                        f++
                    );
                return t;
            },
                    ...
                    if (e.renderable && 0 !== e.alpha) {
                        if (e instanceof t.Sprite)
                            e.texture.frame &&
                                ...
                                this.smoothProperty &&
                                    this.scaleMode !== e.texture.baseTexture.scaleMode &&
                                    ((this.scaleMode = e.texture.baseTexture.scaleMode), (this.context[this.smoothProperty] = this.scaleMode === t.BaseTexture.SCALE_MODE.LINEAR)),
                                this.context.drawImage(
                                    e.texture.baseTexture.source,
                                    e.texture.frame.x,
                                    e.texture.frame.y,
                            ...
                            this.context.setTransform(e.worldTransform[0], e.worldTransform[3], e.worldTransform[1], e.worldTransform[4], e.worldTransform[2], e.worldTransform[5]), this.renderTilingSprite(e);
        ...
        (a = function (e, t) {
            ...
            (t = function () {
                ...
                console.log("%chttps://github.com/hyspace/flappy", "color: black; font-size: x-large"),
                    ...
                    (e > 1.15 || 0.7 > e) && (document.querySelector("#github").innerHTML = githubHtml),
                    setTimeout(function() {
                     // Hide the loading element after 500 milliseconds
                    ...
                    (scoreText = r.add.text(r.world.width / 2, r.world.height / 4, "", { font: '16px "Press Start 2P"', fill: "#fff", stroke: "#430", strokeThickness: 4, align: "center" })),
                    scoreText.anchor.setTo(0.5, 0.5),
                    (instText = r.add.text(r.world.width / 2, r.world.height - r.world.height / 4, "", { font: '8px "Press Start 2P"', fill: "#fff", stroke: "#430", strokeThickness: 4, align: "center" })),
                    instText.anchor.setTo(0.5, 0.5),
                    (gameOverText = r.add.text(r.world.width / 2, r.world.height / 2, "", { font: '16px "Press Start 2P"', fill: "#fff", stroke: "#430", strokeThickness: 4, align: "center" })),
            ...
            (h = function () {
                ...
                gameStarted
                    ? gameOver
                        ? ((t = r.add.tween(bird).to({ angle: 90 }, 100, Phaser.Easing.Bounce.Out, !0)),
                    ...
                    : ((bird.y = r.world.height / 2 + 8 * Math.cos(r.time.now / 200)), (bird.angle = 0)),
